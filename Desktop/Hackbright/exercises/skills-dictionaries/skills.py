...
def common_items(list1, list2):
    ...
    # return common items for variable in list1 and list2
...
def sum_zero(list1):
    ...
    list_tuples = tuple(new_list[i])
    return list_tuples
    # set_trans = set(new_list)
    # no_dups_list = list(set_trans)
...
def find_duplicates(words):
    ...
    return [word for word in words if word.count(words) > 1]
